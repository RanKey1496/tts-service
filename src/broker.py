...
async def main():
    try:
        ...
        data = {"id": 1, "text": "Ducati es reconocida mundialmente como un símbolo de lujo y alto rendimiento en el mundo de las motocicletas. Su diseño italiano impecable, combinado con tecnologías innovadoras como la distribución desmodrómica, ha establecido estándares en el segmento de las motos deportivas y de lujo.", "speaker": "daniel"}
